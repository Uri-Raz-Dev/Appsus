    ...
    return (
        <nav className={isCollapse ? "email-folder-list flex collapse" : "email-folder-list flex"}>
            ...
            <Link onClick={openCompose} className="compose-wrapper flex" to="compose">
                ...
                {!isCollapse && <div className="compose">Compose</div>}
            </Link>
